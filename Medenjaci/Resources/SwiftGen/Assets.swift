...
internal enum Assets {
  ...
  internal enum Images {
    ...
    internal static let product2 = ImageAsset(name: "product-2")
    internal static let product3 = ImageAsset(name: "product-3")
    internal static let product4 = ImageAsset(name: "product-4")
  }
}
